...
public class TecnicoDTO {
    ...
    @NotBlank(message = "O campo ESPECIALIDADE TECNICA é obrigatório")
    private EspecialidadeTecnica especialidadeTecnica;

    @NotBlank(message = "O campo NÚMERO REGISTRO PROFISSIONAL é obrigatório")
